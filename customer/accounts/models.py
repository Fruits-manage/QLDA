...
class User(AbstractUser):
    """Custom User model cho Customer Portal"""
    ROLE_CHOICES = [
        ('customer', 'Khách hàng'),
        ('premium_customer', 'Khách hàng VIP'),
    ...
    role = models.CharField(max_length=20, choices=ROLE_CHOICES, default='customer', verbose_name="Loại khách hàng")
    avatar = models.ImageField(upload_to='avatars/', blank=True, null=True, verbose_name="Ảnh đại diện")
    is_active_customer = models.BooleanField(default=True, verbose_name="Đang hoạt động")
