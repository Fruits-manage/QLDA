...
from customer_portal.models import CustomerProfile  # Sử dụng CustomerProfile thay cho CustomerProfile
...
class Order(models.Model):
    ...
    customer = models.ForeignKey(CustomerProfile, on_delete=models.CASCADE, verbose_name="Khách hàng")  # Thay customer bằng customer
    ...
    def __str__(self):
        return f"{self.order_number} - {self.customer.user.get_full_name() or self.customer.user.username}"
