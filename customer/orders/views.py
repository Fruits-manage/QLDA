...
from customer_portal.models import CustomerProfile  # Thay CustomerProfile bằng CustomerProfile
...
class OrderCreateView(LoginRequiredMixin, CreateView):
    ...
    fields = ['order_type', 'customer', 'delivery_date', 'shipping_address', 'notes', 'payment_status']
    success_url = reverse_lazy('orders:list')
    
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['customers'] = CustomerProfile.objects.filter(is_verified=True)
...
class OrderUpdateView(LoginRequiredMixin, UpdateView):
    ...
    fields = ['customer', 'order_type', 'delivery_date', 'shipping_address', 'shipping_contact', 'shipping_phone', 'notes', 'status', 'payment_status']
    context_object_name = 'order'
...
class OrderAPICreateView(View):
    ...
    def post(self, request):
        try:
            ...
            required_fields = ['customer_id', 'order_type', 'delivery_date', 'order_details']
            ...
            try:
                ...
                return JsonResponse({
                    'success': False,
                    'error': f'CustomerProfile with ID {data["customer_id"]} not found'
                }, status=400)
