...
from accounts.models import FarmerProfile  # Farmer portal dùng FarmerProfile
...
class Order(models.Model):
    ...
    farmer = models.ForeignKey(FarmerProfile, on_delete=models.CASCADE, verbose_name="Công ty")
    ...
    def __str__(self):
        return f"{self.order_number} - {self.farmer.farmer_name}"
