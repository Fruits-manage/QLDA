...
class OrderListView(LoginRequiredMixin, ListView):
    ...
    def get_queryset(self):
        queryset = Order.objects.select_related('company', 'created_by').all()
...
class OrderCreateView(LoginRequiredMixin, CreateView):
    ...
    fields = ['order_type', 'company', 'delivery_date', 'shipping_address', 'notes', 'payment_status']
...
class OrderUpdateView(LoginRequiredMixin, UpdateView):
    ...
    fields = ['company', 'order_type', 'delivery_date', 'shipping_address', 'shipping_contact', 'shipping_phone', 'notes', 'status', 'payment_status']
    context_object_name = 'order'
...
class OrderAPICreateView(View):
    ...
    def post(self, request):
        try:
            ...
            required_fields = ['company_id', 'order_type', 'delivery_date', 'order_details']
            ...
            try:
                ...
                return JsonResponse({
                    'success': False,
                    'error': f'Company with ID {data["company_id"]} not found'
                }, status=400)
            ...
            with transaction.atomic():
                order = Order.objects.create(
                    ...
                    shipping_address=data.get('shipping_address', company.address),
            ...
            response_data = {
                ...
                'order': {
                    ...
                    'company': {
                        ...
                        'tax_code': order.company.tax_code
                    },
